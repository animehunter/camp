 ...
 */
inline void serialize(const UserObject& object, xercesc::DOMElement* node, const Value& tag = Value::nothing,
    bool include = false, bool throwExceptions = true)
{
    detail::serialize<detail::Xerces>(object, node, tag, include, throwExceptions);
}
 ...
 * \param throwExceptions Set this to false to ignore thrown exceptions.
 */
inline void deserialize(const UserObject& object, xercesc::DOMElement* node, const Value& tag = Value::nothing,
    bool include = false, bool throwExceptions = true)
{
    detail::deserialize<detail::Xerces>(object, node, tag, include, throwExceptions);
}
